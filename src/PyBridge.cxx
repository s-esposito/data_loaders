...
PYBIND11_MODULE(dataloaders, m) {
    ...
    .def("set_load_mask", &DataLoaderNerf::set_load_mask )
    .def("set_dataset_path", &DataLoaderNerf::set_dataset_path )
    .def("set_restrict_to_scene_name", &DataLoaderNerf::set_restrict_to_scene_name )
    .def("get_restrict_to_scene_name", &DataLoaderNerf::get_restrict_to_scene_name )
    ...
    .def("set_bg_color", &DataLoaderNerf::set_bg_color )
    ;
    ...
    .def("set_subsample_factor", &DataLoaderDTU::set_subsample_factor )
    ...
    .def("get_day_with_idx", &DataLoaderPhenorobCP1::get_day_with_idx )
    ...
    .def("rgb_subsample_factor", &DataLoaderPhenorobCP1::rgb_subsample_factor )
    ...
    .def("nr_days", &DataLoaderPhenorobCP1::nr_days )
    .def("loaded_dense_cloud", &DataLoaderPhenorobCP1::loaded_dense_cloud )
    .def("set_dataset_path", &DataLoaderPhenorobCP1::set_dataset_path )
    .def("set_restrict_to_date", &DataLoaderPhenorobCP1::set_restrict_to_date )
    .def("set_scene_normalization_file", &DataLoaderPhenorobCP1::set_scene_normalization_file )
    .def("set_rgb_subsample_factor", &DataLoaderPhenorobCP1::set_rgb_subsample_factor )
    ...
    .def("get_scan_with_idx", &PRCP1Day::get_scan_with_idx )
    .def("date", &PRCP1Day::date )
    ;
